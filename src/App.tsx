...
const RecordingPatchLayoutWithoutLeg = styled.div`
padding: 8px;
  display: grid;
  column-gap: 8px;
  justify-items: left;
...
function App() {
  ...
  return (
    ...
    <PageLayoutWidescreen style={{height: "100%", width: "80vw", justifyContent: "center"}}>
    <div style={{gridArea: "header", minWidth:"100%", minHeight:"100%", backgroundColor: "purple"}}></div>
    <div style={{gridArea: "welcome", width:"100%", height:"100%", backgroundColor: "green"}}></div>
    <div style={{gridArea: "headshot" ,backgroundColor: "blue"}}>
    </div>
    <div style={{display: "grid", gridArea: "name-blurb", backgroundColor: "teal"}}>
    </div>
    <div style={{display: "grid", gridArea: "about-me", backgroundColor: "cornflower"}}></div>
    ...
    <div style={{display: "grid", gridArea: "fees"}}>
    </div>
    <div style={{display: "grid", gridArea: "email-me"}}>
    </div>
